...
var sendForm = function (fb_name, fb_phone, fb_mail, fb_course_type, fb_subscribe, fb_type) {
    jQuery.ajax({
        url:"/managym/make_order/",
        type:"post",
        data:"query[subscribe]=" + fb_subscribe + "&query[course_type]=" + fb_course_type + "&query[name]=" + fb_name + "&query[tel]=" + fb_phone + "&query[email]=" + fb_mail + "&query[type]=" + fb_type,
