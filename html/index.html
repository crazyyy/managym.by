...
<head>
  ...
  <link rel="icon" type="image/vnd.microsoft.icon" href="assets/ifavico.ico">
        ...
        <div class="fw">
          <div class="center-col">
            <div class="txt-col"><strong>Жесткая сертификация участников</strong>
              <p>По итогам обучения слушатели курсов получают
                <br> сертификат, подтверждающий успешное
                <br> прохождение курса.
                <br>
                <br> Мы применяем дифференцированный подход,
                <br> поэтому, каждый из вас получит тот сертификат,
        ...
        <div class="right-col">
          ...
          <div class="txt-col" style="padding-bottom:60px;"><strong>Опытный тренер-практик</strong>
            <p>Занятия проводит Сертифицированный
              ...
              <br> (Registered Project Management Professional —
              <br> RPMP).
              <br>
              <br> Тренер и консультант с 10-летним стажем,
...
«Heineken-Беларусь».</b></p>
          <div class="text">
            <p>С 2004 г. Сертифицированный Специалист по Управлению Проектами — СПУП
              <br> (Registered Project Management Professional — RPMP).</p>
            <p>Управленец с 15-летним стажем. Тренер и консультант с 10-летним стажем.</p>
            <p><b>Консультировал и тренировал управленческие команды:</b> «ЮКОС»,
              <br> «ЮниМилк», «ZTE», «Henkel», «Silverado», «Русские сладости», «Евросеть»,
              <br> «Развитие Бизнес Систем», «Itransition», «АЛАГОН», «Чайковский текстиль»,
              <br> «Ассопт-Торг», «Импресс Медиа Групп», «РДТЕХ», «Бизнес-Букет», «Морон»,
              <br> «Прайм-тайм»...
              <br> И мы можем продолжать еще :)</p>
            <p><b>Основная специализация:</b> тренировка и коучинг менеджеров среднего
              <br>и топ-уровня.</p>
            <p><b>География тренерского опыта:</b> от Калининграда — «АЛАГОН»,
              <br>до Нефтеюганска — «Юкос».</p>
            <p><b>Сферы бизнеса:</b> от B2C-ритейла — «Евросеть», до B2B IT-аутсорсинга —
              <br> «Itransition».</p>
            <div class="clear"></div>
          </div>
  ...
  <div class="kurs-programm" id="courses">
    <div class="wrap">
      ...
      <p style="text-align: center;font: 14px Tahoma; color:#434343">Программа рассчитана на 9 дней, из них: 8 дней тренинга (более 33 часов), каждодневная практика выполнения «кейса
        ...
        <br> управленческих навыков на уникальных тренажерах.</p>
      ...
      <div class="lessons-bloks teach">
        ...
        <div class="lesson" style="display:block">
          <p>Зубодробительная бизнес-симуляция, которая дает каждому из участников прожить 5 лет в корпорации за 5 часов. Взлеты и подставы,
            <br> невменяемые подчиненные, конкурентная борьба за власть и, наконец, власть. Вы узнаете о себе все, а самое главное, свой потенциал
            <br> как управленца и его белые пятна, которые вам предстоит шлифовать оставшиеся 8 дней интенсива MANAGYM.</p>
        </div>
        <div class="lesson">
        ...
        <div class="lesson">
          <p>Ощутить себя доктором Хаусом в операционной вы гарантированно сможете, а вот спасти человека удастся только четко выполняя все то, что вы усвоили за предыдущие дни тренировок.
            <br> Вам сегодня придется управлять по-взрослому. Причем управлять не исполнителями, а равными вам по компетенциям. Выбирайте стиль, речь, маску, тип мотивации, ставьте контроль и тайминг под него, учтите групповую динамику и все остальное, чего было так много, но только спасите жизнь человеку.</p>
        </div>
        <div class="lesson">
...
<textarea rows="5" id="ap_info" cols="100"></textarea>
  ...
  <script type="text/javascript" src="js/inline_5.js"></script>
  <script type="text/javascript" src="js/inline_6.js"></script>
  <script type="text/javascript" src="js/inline_7.js"></script>
  <script src="js/inline_8.js"></script>
  <script src="js/inline_9.js"></script>
  <script type="text/javascript" src="js/inline_10.js"></script>
